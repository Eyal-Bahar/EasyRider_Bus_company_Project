""" A project showcasing use OOP for very messy data validation.
* Testing data consistency and correctness, 
* JSON format data
* Regular expression library.

Simulating a bus company task for an uncpmlete database managment task : 
...
This project helps to plunge into the real reality. A good workout before work. Respect to the developers!
"""
